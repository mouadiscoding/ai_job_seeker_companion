...
public class StatRekrute extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StatRekrute frame = new StatRekrute();
	...
	public StatRekrute() {
		...
		Rekrutechoise.setBounds(100, 400, 160, 27);
		...
		label.addMouseMotionListener(new MouseMotionAdapter() {
		    ...
		    public void mouseDragged(MouseEvent arg0) {
		        ...
		        StatRekrute.this.setLocation(x - xx, y - xy);
		    }
		});
		...
		JLabel titleRekrute = new JLabel("STATISTICS FROM REKRUTE");
		...
		dataDateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        RekruteByDate rekruteByDate = new RekruteByDate("Job offers by Date");
		        rekruteByDate.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		        rekruteByDate.setSize(760, 567);
		        rekruteByDate.setLocationRelativeTo(null);
		        rekruteByDate.setVisible(true);
		    }
		});
		...
		dataSectorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	RekruteBySector rekruteByDate = new RekruteBySector("Job offers by Date");
            	rekruteByDate.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            	rekruteByDate.setSize(760, 567);
            	rekruteByDate.setLocationRelativeTo(null);
            	rekruteByDate.setVisible(true);
		...
		dataRegionButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	RekruteByRegion rekruteByDate = new RekruteByRegion("Job offers by Date");
            	rekruteByDate.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            	rekruteByDate.setSize(760, 567);
            	rekruteByDate.setLocationRelativeTo(null);
            	rekruteByDate.setVisible(true);
