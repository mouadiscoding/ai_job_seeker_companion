...
public class Emploi extends JFrame {
	...
	public Emploi() {
		...
		stats.addMouseListener(new MouseAdapter() {
		    ...
		    public void mouseClicked(MouseEvent e) {
		        dispose();
		        SwingUtilities.invokeLater(() -> {
		            StatEmploi dashboard3 = new StatEmploi();
		            dashboard3.setUndecorated(true);
		            dashboard3.setLocationRelativeTo(null);
		            dashboard3.setVisible(true);
		        });
		...
		label.addMouseMotionListener(new MouseMotionAdapter() {
		    ...
		    public void mouseDragged(MouseEvent arg0) {
		        ...
		        Emploi.this.setLocation(x - xx, y - xy);
		    }
		});
		...
		JLabel titleRekrute = new JLabel("OFFERS FROM EMPLOI");
		...
		titleRekrute.setBounds(385,120, 200, 14);
	...
	private void showDashboard() {
        SwingUtilities.invokeLater(() -> {
        	Dashboard1Emploi dashboard1 = new Dashboard1Emploi();
	...
	private void showDashboard2() {
        SwingUtilities.invokeLater(() -> {
        	Dashboard2Emploi dashboard2 = new Dashboard2Emploi();
