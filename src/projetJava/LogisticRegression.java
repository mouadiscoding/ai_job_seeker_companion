...
public class LogisticRegression {
    public static void main(String[] args) throws Exception {
        ...
        if (targetAttr.isNominal()) {
            ...
            lr.buildClassifier(balancedTrainingData);

            String modelFilePath = "LogisticRegression_model.model";

            // Save the trained random forest classifier to a file
            SerializationHelper.write(modelFilePath, lr);
            ...
            int folds = 5;
            eval.crossValidateModel(lr, balancedTrainingData, folds, randomSeed);
            ...
            eval1.evaluateModel(lr, testData);
            System.out.println(eval1.toSummaryString());

            Evaluation eval2 = new Evaluation(balancedTrainingData);
            eval2.evaluateModel(lr, testData);
