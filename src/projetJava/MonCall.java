...
public class MonCall extends JFrame {
	...
	public MonCall() {
		...
		companies.setBounds(100, 400, 160, 27);
		panel.add(companies);
		...
		companies.addMouseListener(new MouseAdapter() {
		    ...
		    public void mouseClicked(MouseEvent e) {
		        dispose();
		        SwingUtilities.invokeLater(() -> {
		            Dashboard3Emploi dashboard3 = new Dashboard3Emploi();
		...
		label.addMouseMotionListener(new MouseMotionAdapter() {
		    ...
		    public void mouseDragged(MouseEvent arg0) {
		        ...
		        MonCall.this.setLocation(x - xx, y - xy);
		    }
		});
		...
		JLabel titleRekrute = new JLabel("OFFERS FROM MONCALLCENTER");
		...
		titleRekrute.setBounds(390,120, 260, 14);
	...
	private void showDashboard() {
        SwingUtilities.invokeLater(() -> {
        	Dashboard1MonCall dashboard1 = new Dashboard1MonCall();
	...
	private void showDashboard2() {
        SwingUtilities.invokeLater(() -> {
        	Dashboard2MonCall dashboard2 = new Dashboard2MonCall();
