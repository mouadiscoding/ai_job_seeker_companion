...
public class SVM {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (targetAttr.isNominal()) {
            ...
            System.out.println("Number of attributes after preprocessing: " + numAttributes);
            ...
            svm.buildClassifier(balancedTrainingData);

            String modelFilePath = "SVM_model.model";

            // Save the trained random forest classifier to a file
            SerializationHelper.write(modelFilePath, svm);
            ...
            int folds = 5;
            eval.crossValidateModel(svm, balancedTrainingData, folds, randomSeed);
            ...
            eval1.evaluateModel(svm, testData);
