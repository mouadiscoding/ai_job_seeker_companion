...
public class NaiveBayes {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (targetAttr.isNominal()) {
            ...
            System.out.println("indices of rows with Nan values:"+ indicesToDelete);
            System.out.println("number of rows with Nan values:"+ indicesToDelete.size());
            ...
            nb.buildClassifier(balancedTrainingData);
            ...
            int folds = 5;
            eval.crossValidateModel(nb, balancedTrainingData, folds, randomSeed);
