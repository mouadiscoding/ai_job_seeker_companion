...
public class MJob extends JFrame {
	...
	public MJob() {
		...
		companies.addMouseListener(new MouseAdapter() {
		    ...
		    public void mouseClicked(MouseEvent e) {
		        dispose();
		        SwingUtilities.invokeLater(() -> {
		            Dashboard3MJob dashboard3 = new Dashboard3MJob();
		...
		stats.addMouseListener(new MouseAdapter() {
		    ...
		    public void mouseClicked(MouseEvent e) {
		        dispose();
		        SwingUtilities.invokeLater(() -> {
		            StatMJob dashboard3 = new StatMJob();
		            dashboard3.setUndecorated(true);
		            dashboard3.setLocationRelativeTo(null);
		            dashboard3.setVisible(true);
		        });
		...
		label.addMouseMotionListener(new MouseMotionAdapter() {
		    ...
		    public void mouseDragged(MouseEvent arg0) {
		        ...
		        MJob.this.setLocation(x - xx, y - xy);
		    }
		});
		...
		JLabel titleMJob = new JLabel("OFFERS FROM MENARA JOB");
		titleMJob.setHorizontalAlignment(SwingConstants.CENTER);
		titleMJob.setForeground(new Color(0x706b63));
		titleMJob.setFont(new Font("Tahoma", Font.BOLD, 15));
		titleMJob.setBounds(385,120, 240, 14);
		contentPane.add(titleMJob);
	...
	private void showDashboard() {
        SwingUtilities.invokeLater(() -> {
        	Dashboard1MJob dashboard1 = new Dashboard1MJob();
	...
	private void showDashboard2() {
        SwingUtilities.invokeLater(() -> {
        	Dashboard2MJob dashboard2 = new Dashboard2MJob();
